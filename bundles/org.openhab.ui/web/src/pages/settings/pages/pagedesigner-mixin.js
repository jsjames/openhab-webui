...
export default {
  ...
  methods: {
    ...
    configureWidget(component, parentContext, forceComponentType) {
      ...
      f7.on('widget-config-update', this.updateWidgetConfig);
      f7.once('widget-config-closed', () => {
        f7.off('widget-config-update', this.updateWidgetConfig);
    ...
    editWidgetCode(component, parentContext, slot) {
      ...
      f7.on('widget-code-update', this.updateWidgetCode);
      f7.once('widget-code-closed', () => {
        f7.off('widget-code-update', this.updateWidgetCode);
