  ...
  <f7-page
    ...
    <f7-block class="no-padding" style="margin-top: 0">
      <f7-searchbar
        ...
        custom-search
        :placeholder="
          'Search ' + Object.assign({ main: 'all add-ons' }, AddonTitles)[currentTab].toLowerCase()
        "
      ...
      <f7-tab id="automation" @tab-show="onTabShow">
        ...
        <addons-section
          ...
          :addons="
            allAddons.filter(
              a =>
                a.type === 'automation' && a.contentType === 'application/vnd.openhab.ruletemplate'
            )
          "
        ...
        <addons-section
          ...
          :addons="
            marketplaceAddons.filter(
              a =>
                a.type === 'ui' &&
                a.contentType === 'application/vnd.openhab.uicomponent;type=widget'
            )
          "
          :install-action-text="'Add'"
          :show-as-cards="true"
