...
export const TrendLineParameterGroup = () =>
  pg('trend', 'Trend Line', 'Trend Line Background Options')
...
export const OhCellDefinition = () =>
  new WidgetDefinition('oh-cell', 'Cell', 'A regular or expandable cell')
...
// OhLabelCell
export const OhLabelCellDefinition = () =>
