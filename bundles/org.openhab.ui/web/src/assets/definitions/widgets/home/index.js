...
export const OhHomePageDefinition = () =>
  new WidgetDefinition('oh-home-page', 'Home page').params([
    pb(
      'simpleNavbarMobileDefault',
      'Default to Simple Navbar on Mobile',
      'Use the simple navbar by default on mobile devices'
    ),
    pb(
      'simpleNavbarDesktopDefault',
      'Default to Simple Navbar on Desktop',
      'Use the simple navbar by default on desktop devices'
    ),
    pb(
      'standardBackgroundMobileDefault',
      'Default to Standard Background on Mobile',
      'Use the standard background (light grey in light mode) by default on mobile devices'
    ),
    pb(
      'standardBackgroundDesktopDefault',
      'Default to Standard Background on Desktop',
      'Use the standard background (light grey in light mode) by default on desktop devices'
    ),
    pt(
      'displayModelCardsTo',
      'Display model cards to',
      'Restrict who sees the Locations/Equipment/Properties tabs with the model cards'
    )
      .o([
    ...
    pt(
      'allowChatInputTo',
      'Allow chat input box to',
      'Restrict who can interact with the chatbot input box on the top of the Overview tab (when available)'
    )
      .o([
        { value: 'role:administrator', label: 'Administrators' },
        { value: 'role:user', label: 'Users' }
...
const EquipmentListParameters = () => [
  ...
  pt(
    ...
    'Label for promoted elements',
    'Choose what to include in the labels of promoted items'
  )
    .o([
...
const ItemSubtitleParameters = () => [
  pt(
    'contextLabelSource',
    'Label for providing context of items',
    'Choose what to display as the context label of items (either in footer or in dividers). This can be used for dis-ambiguation if several items share the same label.'
  ).o([
...
export const OhLocationCardParameters = () =>
  new WidgetDefinition(
    ...
    .paramGroup(
      ...
      [pi('item', 'Item', 'Location to display')].concat(ModelCardParameters())
    )
