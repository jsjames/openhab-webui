...
const ClearVariableParameter = pb(
  'clearVariable',
  'Clear Variable After Action',
  'Name of the variable to clear after performing the action'
);
const ClearVariableKeyParameter = pb(
  'clearVariableKey',
  'Clear Object Variable Property After Action',
...
export const OhButtonDefinition = () =>
  new WidgetDefinition('oh-button', 'Button', 'Button performing an action')
    ...
    .params([
      ...
      ClearVariableParameter,
      ClearVariableKeyParameter,
    ]);

import ChartParameters from './chart.js';
export const OhChartDefinition = () =>
  new WidgetDefinition('oh-chart', 'Chart', 'Visualize series of data').params(ChartParameters());

import ColorpickerParameters from './colorpicker.js';
export const OhColorpickerDefinition = () =>
  new WidgetDefinition('oh-colorpicker', 'Colorpicker', 'Control to pick a color').params(
...
export const OhGaugeDefinition = () =>
  new WidgetDefinition('oh-gauge', 'Gauge', 'Circular or semi-circular read-only gauge').params(
    GaugeParameters()
  );

import IconParameters from './icon.js';
export const OhIconDefinition = () =>
  new WidgetDefinition('oh-icon', 'Icon', 'Display an openHAB icon')
    .paramGroup(actionGroup(), actionParams())
...
export const OhListDefinition = () =>
  new WidgetDefinition('oh-list', 'List', 'List control, hosts list items').params(
    ListParameters()
  );
...
export const OhWebFrameDefinition = () =>
  new WidgetDefinition('oh-webframe', 'Web frame', 'Displays a web page in a frame').params(
    WebFrameParameters()
  );
...
export const OhClockDefinition = () =>
  new WidgetDefinition('oh-clock', 'Digital Clock', 'Display a digital clock').params(
    ClockParameters()
  );
