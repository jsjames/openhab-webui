...
export default function (f7) {
  ...
  javascriptGenerator.forBlock['oh_bit_not'] = function (block) {
    const value = javascriptGenerator.valueToCode(
      block,
      'value',
      javascriptGenerator.ORDER_BITWISE_NOT
    );
    return [`~${value}`, 0];
  };
  ...
  javascriptGenerator.forBlock['oh_bitwise'] = function (block) {
    const first = javascriptGenerator.valueToCode(
      block,
      'first',
  ...
  javascriptGenerator.forBlock['math_round'] = function (block) {
    ...
    const math_number_input = javascriptGenerator.valueToCode(
      block,
      'NUM',
      javascriptGenerator.ORDER_FUNCTION_CALL
    );
    ...
    const decimals = javascriptGenerator.valueToCode(
      block,
      'DECIMALS',
  ...
  function computeMinMaxOutputType(block, throwError = false) {
    ...
    try {
      ...
      math_number_input1 = javascriptGenerator.valueToCode(
        block,
        'NUM1',
        javascriptGenerator.ORDER_FUNCTION_CALL
      );
      math_number_input2 = javascriptGenerator.valueToCode(
        block,
        'NUM2',
        javascriptGenerator.ORDER_FUNCTION_CALL
      );
