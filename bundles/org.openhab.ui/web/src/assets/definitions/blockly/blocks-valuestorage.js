...
export default function defineOHBlocks_Variables(f7) {
  Blockly.Blocks['oh_store_value'] = {
    init: function () {
      ...
      this.setHelpUrl(
        'https://www.openhab.org/docs/configuration/blockly/rules-blockly-value-storage.html#store-value'
      );
    },
  };
  ...
  Blockly.Blocks['oh_get_value'] = {
    init: function () {
      ...
      this.setHelpUrl(
        'https://www.openhab.org/docs/configuration/blockly/rules-blockly-value-storage.html#get-stored-value'
      );
    },
  };
  ...
  Blockly.Blocks['oh_check_undefined_value'] = {
    init: function () {
      ...
      this.setColour(0);
      this.setTooltip(
        'returns whether the given value is undefined in the private rule or shared global cache'
      );
      this.setHelpUrl(
        'https://www.openhab.org/docs/configuration/blockly/rules-blockly-value-storage.html#check-if-value-is-undefined'
      );
    },
  };
