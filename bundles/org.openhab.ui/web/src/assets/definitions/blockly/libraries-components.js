...
export const BlockLibrariesComponentDefinitions = {
  BlockLibraryDefinition: () =>
    new WidgetDefinition(
      'BlockLibrary',
      'Block Library',
      'Root component of a block library.'
    ).params([
      pt(
        'name',
        'Name',
  ...
  BlockTypeDefinition: () =>
    new WidgetDefinition(
      ...
      pt(
        'type',
        'Type',
        'The identifier for the new type. The actual full identifier will be {block library id}_{type}.'
      ),
      pb(
        'inputsInline',
        'Inputs Inline',
  ...
  PresetInputDefinition: () =>
    new WidgetDefinition(
      'PresetInput',
      'Preset Input',
      'Defines a new preset for an input of a BlockType.'
    ).params([
      pt(
        'name',
        'Name',
        'The name of the input in the parent block type this preset input is for.'
      ),
  ...
  PresetFieldDefinition: () =>
    new WidgetDefinition(
      'PresetField',
      'Preset Field',
      'Defines a new preset for an field of a BlockType.'
    ).params([
      pt(
        'name',
        'Name',
  ...
  SeparatorDefinition: () =>
    new WidgetDefinition(
      'Separator',
      'Separator',
      'Defines a separator between blocks in the toolbox.'
    ).params([pn('gap', 'Gap', 'Gap in pixels for the separator.')]),
