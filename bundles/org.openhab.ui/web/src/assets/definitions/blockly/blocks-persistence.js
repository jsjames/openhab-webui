...
export default function defineOHBlocks_Persistence(f7, persistenceServices) {
  ...
  Blockly.Blocks['oh_get_persistvalue'] = {
    init: function () {
      ...
      this.setTooltip(() => {
        ...
        let TIP = {
          ...
          medianSince:
            'Gets the median value of the State of the Item since a certain point in time',
          medianUntil:
            'Gets the median value of the State of the Item until a certain point in time',
          medianBetween:
            'Gets the median value of the State of the Item between two points in time',
          deltaSince:
            'Gets the difference in value of the State of the Item since a certain point in time',
          deltaUntil:
            'Gets the difference in value of the State of the Item until a certain point in time',
          deltaBetween:
            'Gets the difference in value of the State of the Item between two points in time',
          deviationSince:
            'Gets the standard deviation of the State of the Item since a certain point in time',
          deviationUntil:
            'Gets the standard deviation of the State of the Item until a certain point in time',
          deviationBetween:
            'Gets the standard deviation of the State of the Item between two points in time',
          ...
          evolutionRateSince:
            'Gets the evolution rate of the State of the Item since a certain point in time',
          evolutionRateUntil:
            'Gets the evolution rate of the State of the Item until a certain point in time',
          evolutionRateBetween:
            'Gets the evolution rate of the State of the Item between two points in time',
          minimumSince:
            'Gets the minimum value of the State of the Item since a certain point in time',
          minimumUntil:
            'Gets the minimum value of the State of the Item until a certain point in time',
          minimumBetween:
            'Gets the minimum value of the State of the Item between two points in time',
          maximumSince:
            'Gets the maximum value of the State of the Item since a certain point in time',
          maximumUntil:
            'Gets the maximum value of the State of the Item until a certain point in time',
          maximumBetween:
            'Gets the maximum value of the State of the Item between two points in time',
          riemannSumSince:
            'Gets the Riemann sum (integral) of the previous States of the Item since a certain point in time',
          riemannSumUntil:
            'Gets the Riemann sum (integral) of the future States of the Item until a certain point in time',
          riemannSumBetween:
            'Gets the Riemann sum (integral) of the States of the Item between two points in time',
          ...
          previousState:
            'Gets the previous State of the Item, with option to skip to different value as current',
          nextState:
            'Gets the next State of the Item, with option to skip to different value as current',
          getAllStatesSince:
            'Gets Array of timestamp and state pairs of persisted items since a certain point in time',
          getAllStatesUntil:
            'Gets Array of timestamp and state pairs of persisted items until a certain point in time',
          getAllStatesBetween:
            'Gets Array of timestamp and state pairs of persisted items between two points in time',
          previousNumericState:
            'Gets the previous State of the Item without the unit, with option to skip to different value as current',
          nextNumericState:
            'Gets the next State of the Item without the unit, with option to skip to different value as current',
          previousStateTime:
            'Gets the time when previous State of the Item last occurred, with option to skip to different value as current',
          nextStateTime:
            'Gets the time when next State of the Item will occur, with option to skip to different value as current',
          countSince:
            'Gets the number of stored State updates of the Item since a certain point in time',
          countUntil:
            'Gets the number of stored State updates of the Item until a certain point in time',
          countBetween:
            'Gets the number of stored State updates of the Item between two points in time',
          countStateChangesSince:
            'Gets the number of State changes of the Item since a certain point in time',
          countStateChangesUntil:
            'Gets the number of State changes of the Item until a certain point in time',
          countStateChangesBetween:
            'Gets the number of State changes of the Item between two points in time',
          persistedState: 'Gets the State of the Item at a certain point in time'
        }
        return TIP[methodName]
      })
      this.setHelpUrl(
        'https://www.openhab.org/docs/configuration/blockly/rules-blockly-persistence.html#get-statistical-value-of-an-item'
      )
    },
    ...
    updateShape: function () {
      ...
      if (!persistenceNameInput.getShadowDom()) {
        persistenceNameInput.setShadowDom(
          Blockly.utils.xml.textToDom('<shadow type="oh_persistence_dropdown" />')
        )
      }
      ...
      let hasSinceField =
        this.methodName.endsWith('Since') ||
        this.methodName.endsWith('Between') ||
        this.methodName === 'persistedState'
  ...
  javascriptGenerator.forBlock['oh_get_persistvalue'] = function (block) {
    ...
    const persistenceName = javascriptGenerator.valueToCode(
      block,
      'persistenceName',
    ...
    let code = ''
    const dayInfoSince = javascriptGenerator.valueToCode(
      block,
      'dayInfoSince',
      javascriptGenerator.ORDER_NONE
    )
    const dayInfoUntil = javascriptGenerator.valueToCode(
      block,
      'dayInfoUntil',
      javascriptGenerator.ORDER_NONE
    )
    const dayInfo = dayInfoSince + (dayInfoSince && dayInfoUntil ? ', ' : '') + dayInfoUntil
    let skipPrevious = javascriptGenerator.valueToCode(
      block,
      'skipPrevious',
      javascriptGenerator.ORDER_NONE
    )
    ...
    switch (methodName) {
      ...
      case 'previousState':
      case 'nextState':
        code = `${itemCode}.persistence.${methodName}(${skipPrevious}${persistenceExtension})?.${returnTypeName}`
        break

      case 'previousNumericState':
        code = `${itemCode}.persistence.previousState(${skipPrevious}${persistenceExtension})?.numericState`
        break
      case 'nextNumericState':
        code = `${itemCode}.persistence.nextState(${skipPrevious}${persistenceExtension})?.numericState`
        break

      case 'previousStateTime':
        code = `${itemCode}.persistence.previousState(${skipPrevious}${persistenceExtension})?.timestamp`
        break
      case 'nextStateTime':
        code = `${itemCode}.persistence.nextState(${skipPrevious}${persistenceExtension})?.timestamp`
        break
      ...
      case 'getAllStatesUntil':
      case 'getAllStatesBetween':
        code = `${itemCode}.persistence.${methodName}(${dayInfo}${persistenceExtension}).map(v => ([v.timestamp, v.${returnTypeName}]))`
        break

      default:
        code = `${itemCode}.persistence.${methodName}(${dayInfo}${persistenceExtension})`
        break
    }
    ...
    init: function () {
      ...
      this.setTooltip(function () {
        ...
        let TIP = {
          ...
          changedUntil:
            'Checks if the State of the Item will have (ever) changed until a certain point in time',
          changedBetween:
            'Checks if the State of the Item will have (ever) changed between two points in time',
          updatedSince:
            'Checks if the State of the Item has been updated since a certain point in time',
          updatedUntil:
            'Checks if the State of the Item will have been updated until a certain point in time',
          updatedBetween:
            'Checks if the State of the Item will have been updated between two points in time'
        }
        return TIP[methodName]
      })
  ...
  javascriptGenerator.forBlock['oh_persist_changed'] = function (block) {
    ...
    const methodName = block.getFieldValue('methodName')
    const dayInfo1 = javascriptGenerator.valueToCode(
      block,
      'dayInfo',
      javascriptGenerator.ORDER_NONE
    )
    const dayInfo2 = methodName.endsWith('Between')
      ? javascriptGenerator.valueToCode(block, 'dayInfo2', javascriptGenerator.ORDER_NONE)
      : undefined
    ...
    return [
      `${itemCode}.persistence.${methodName}(${dayInfo}${persistenceExtension})`,
      javascriptGenerator.ORDER_NONE
    ]
  }
  ...
  Blockly.Blocks['oh_get_persistence_lastupdate'] = {
    init: function () {
      ...
      this.setTooltip(() => {
        ...
        const TIP = {
          lastUpdate:
            'Get the last update time of the provided item (null if the item state changed since last being persisted)',
          nextUpdate: 'Get the next update time of the provided item',
          lastChange:
            'Get the last changed time of the provided item (null if the item state changed since last being persisted)',
  ...
  Blockly.Blocks['oh_persist'] = {
    init: function () {
      ...
      this.setTooltip(() => {
        ...
        const TIP = {
          currentState:
            'Persist a state to Item Persistence at current time (this does not update the state of the item)',
          stateAt: 'Persist a state to Item Persistence at a given point in time',
          statesListADD:
            'Persist a list of timestamp and state pairs to Item Persistence, update/add to existing persisted states',
          statesListREPLACE:
      ...
      this.setHelpUrl(
        'https://www.openhab.org/docs/configuration/blockly/rules-blockly-persistence.html#persist-item'
      )
  ...
  javascriptGenerator.forBlock['oh_persist'] = function (block) {
    ...
    const states = javascriptGenerator.valueToCode(
      block,
      'states',
      javascriptGenerator.ORDER_ATOMIC
    )
    ...
    switch (persistType) {
      case 'currentState':
        code += `${itemCode}.persistence.persist(${states}${persistenceExtension});`
        break
      case 'stateAt':
        code += `${itemCode}.persistence.persist(${at}, ${states}${persistenceExtension});`
        break
      case 'statesListADD':
      case 'statesListREPLACE':
        const timeSeriesVar = javascriptGenerator.nameDB_.getDistinctName(
          'timeSeries',
          Blockly.Names.NameType.VARIABLE
        )
        code += `var ${timeSeriesVar} = new items.TimeSeries('${policy}');\n`
        code += `${states}.forEach(s => ${timeSeriesVar}.add(s[0], s[1]));\n`
        code += `${itemCode}.persistence.persist(timeSeries${persistenceExtension});`
        break
      default:
        break
    }
      ...
      this.setTooltip(() => {
        ...
        const TIP = {
          removeAllStatesSince:
            'Delete all persisted states of an Item since a certain point in time',
          removeAllStatesUntil:
            'Delete all persisted states of an Item until a certain point in time',
          removeAllStatesBetween:
            'Delete all persisted states of an Item between two points in time'
        }
        return TIP[methodName]
      })
      this.setHelpUrl(
