<template>
  <div>
    <f7-block
      ...
      class="oh-block"
      :style="{
        'z-index': context.editmode
          ? 100 - context.parent.component.slots.default.indexOf(context.component)
          : 'auto !important',
        ...config.style,
      }">
      ...
      <f7-menu v-if="context.editmode" class="configure-layout-menu padding-bottom">
        ...
        <f7-menu-item style="margin-left: auto" icon-f7="rectangle_grid_1x2" dropdown>
          <f7-menu-dropdown right>
            ...
            <f7-menu-dropdown-item
              v-if="
                context.clipboardtype === 'oh-grid-row' || context.clipboardtype === 'oh-grid-cells'
              "
