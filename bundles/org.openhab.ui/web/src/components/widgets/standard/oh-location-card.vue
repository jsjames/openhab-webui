...
export default {
  ...
  computed: {
    element() {
      return (
        this.$store.getters.semanticModelElement(this.config.item, 'location') || {
    ...
    parentLocationName() {
      return this.element && this.element.parent
        ? this.element.parent.label || this.element.parent.name
        : ''
    }
  },
