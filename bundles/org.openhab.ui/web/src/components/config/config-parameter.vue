  ...
  computed: {
    ...
    control() {
      ...
      if (
        ...
        (!configDescription.context || configDescription.context === 'network-interface')
      ) {
        ...
        configDescription.type === 'TEXT' &&
        configDescription.context === 'cronexpression'
      ) {
        ...
        configDescription.type === 'TEXT' &&
        configDescription.context &&
        configDescription.context.indexOf('page') >= 0
      ) {
        return ParameterPageWidget;
      } else if (
        configDescription.type === 'TEXT' &&
        configDescription.context &&
        configDescription.context.indexOf('widget') >= 0
      ) {
        return ParameterPageWidget;
        ...
        configDescription.type === 'TEXT' &&
        configDescription.context === 'persistenceService'
      ) {
    ...
    description() {
      ...
      ); // if class/target already declared, will be overwritten in most browsers
